<div>
    <div class="flex justify-end">
        <flux:button wire:click='openCreateModal' size="sm" variant='primary'>Tambah Kelas</flux:button>
    </div>
    <div class="overflow-x-auto mt-4">
        <div class="flex gap-4 min-w-2xl font-semibold text-xs md:text-sm py-2">
            <div class="w-10">#</div>
